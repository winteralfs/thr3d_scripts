...
#---------- UV set selection methods ----------
    ...
    def right_listWidget_conflict_detect(self):
        ...
        if self.centric_state_text == 'UV-centric':
            selected_textures = []
            print 'right_listWidget_conflict_detect - UV-centric'
            print 'self.uv_set_selection_status_dic = ',self.uv_set_selection_status_dic
            ...
            print 'selected_textures = ',selected_textures
            print 'conflict after setting to 1 self.uv_set_selection_status_dic = ',self.uv_set_selection_status_dic
            print '---'
            print 'unselecting'
            ...
            while i < self.number_of_items_in_right_listWidget:
                ...
                i = i + 1
            print 'conflict after unselecting and setting to 0 self.uv_set_selection_status_dic = ',self.uv_set_selection_status_dic
            print '-----'
