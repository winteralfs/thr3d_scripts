...
#---
    ...
    def overides_information_function(self):
        ...
        VRayPlaceEnvTex_overrides_dic = self.VRayPlaceEnvTex_overrides()
        ...
        return(vray_settings_overrides_dic,transform_layer_overrides,self.material_overrides_dic,light_overrides_dic,render_stat_overrides,vray_object_property_overrides,camera_overrides_dic,VRayPlaceEnvTex_overrides_dic)
    ...
    def VRayPlaceEnvTex_overrides(self):
        print 'VRayPlaceEnvTex_overrides'
        VRayPlaceEnvTex_overrides_dic = {}
        for VRayPlaceEnvTex in self.VRayPlaceEnvTex_nodes:
            cmds.editRenderLayerGlobals(currentRenderLayer = "defaultRenderLayer")
            horizontal_value = cmds.getAttr(VRayPlaceEnvTex + '.horRotation')
            vertical_value = cmds.getAttr(VRayPlaceEnvTex + '.verRotation')
            VRayPlaceEnvTex_overrides_dic["defaultRenderLayer" + ',horizontal_value'] = horizontal_value
            print 'default horizontal_value = ',horizontal_value
            print 'default vertical_value = ',vertical_value
            VRayPlaceEnvTex_overrides_dic["defaultRenderLayer" + ',vertical_value'] = vertical_value
            for render_layer in self.render_layers:
                if render_layer != "defaultRenderLayer":
                    print render_layer
                    cmds.editRenderLayerGlobals(currentRenderLayer = render_layer)
                    horizontal_value = cmds.getAttr(VRayPlaceEnvTex + '.horRotation')
                    vertical_value = cmds.getAttr(VRayPlaceEnvTex + '.verRotation')
                    print 'horizontal_value = ',horizontal_value
                    print 'vertical_value = ',vertical_value
                    VRayPlaceEnvTex_overrides_dic[render_layer + ',horizontal_value'] = horizontal_value
                    VRayPlaceEnvTex_overrides_dic[render_layer + ',vertical_value'] = vertical_value
        print 'VRayPlaceEnvTex_overrides_dic = ',VRayPlaceEnvTex_overrides_dic
        return (VRayPlaceEnvTex_overrides_dic)
    ...
    def rebuild_layers(self,rebuild_selected_layer):
        expressions = ["expression1","expression2","expression3","expression4","expression5","expression6","expression7"]
        for expression in expressions:
            exp_exists = cmds.objExists(expression)
            if exp_exists == 1:
        ...
        VRayPlaceEnvTex_overrides_dic = overrides[7]
        for render_layer in active_layers:
            if render_layer != "defaultRenderLayer":
                                ...
                                if layer == render_layer:
                                    ...
                                    if kind_float == 1 or kind_int == 1 or kind_bool == 1:
                                        ...
                                        if ramp_removed_found == 1:
                                            a = 1
                                            destination_connections = cmds.listConnections(mo_split_two[1], destination = False, plugs = True, connections = True) or []
                                            print 'destination_connections = ',destination_connections
                                            destination_connections_size = len(destination_connections)
                                            print 'a = ',a
                ...
                print '1 VRayPlaceEnvTex_overrides_dic = ',VRayPlaceEnvTex_overrides_dic
                default_horizontal_value = VRayPlaceEnvTex_overrides_dic['defaultRenderLayer' + ',horizontal_value']
                default_vertical_value = VRayPlaceEnvTex_overrides_dic['defaultRenderLayer' + ',vertical_value']
                horizontal_value = VRayPlaceEnvTex_overrides_dic[render_layer + ',horizontal_value']
                vertical_value = VRayPlaceEnvTex_overrides_dic[render_layer + ',vertical_value']
                print render_layer
                print 'default horizontal_value = ',default_horizontal_value
                print 'default vertical_value = ',default_vertical_value
                print 'horizontal_value = ',horizontal_value
                print 'vertical_value = ',vertical_value
