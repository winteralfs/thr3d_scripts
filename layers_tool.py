...
def overideInfoFunc(renderLayers,vraySetBut,transformObut,materialsObut,cameraObut,lightObut,renderStatsObut,vrayObjectPropertiesObut):
...
def copyAllLayers(renderLayers,vraySetBut,transformObut,materialsObut,cameraObut,lightObut,renderStatsObut,vrayObjectPropertiesObut,materials,*args):
    copyAllLay = "B"
    copyLayers(renderLayers,vraySetBut,transformObut,materialsObut,cameraObut,lightObut,renderStatsObut,vrayObjectPropertiesObut,materials,copyAllLay)

def copyLayers(renderLayers,vraySetBut,transformObut,materialsObut,cameraObut,lightObut,renderStatsObut,vrayObjectPropertiesObut,materials,copyAllLay,*args):
    activeLayers = []
    unlockNodes()
    ...
    lightTypes = ["volumeLight","areaLight","spotLight","pointLight","directionalLight","ambientLight","VRayLightRectShape"]
    overides = overideInfoFunc(renderLayers,vraySetBut,transformObut,materialsObut,cameraObut,lightObut,renderStatsObut,vrayObjectPropertiesObut)
    VrayObjectProps = cmds.ls(type = "VRayObjectProperties")
...
def layer_switcher():
    ...
    if (cmds.window(name, exists = True)):
        cmds.deleteUI(name)
    window = cmds.window(name, title = name, width = 100, height = 10, sizeable = False)        
    ...
    cmds.rowLayout(("objects1"), numberOfColumns = 6, parent = "mainColumn")
    but_adOBJ = cmds.button(label = "add selection",bgc = (.4,.4,.4))
    but_adOBJ_ALL = cmds.button(label = "add selection -all layers",bgc = (.4,.4,.4))
    but_ObjinLayers = cmds.button(label = "ObjinLayers(OIL)",bgc = (.4,.4,.4))
    cmds.rowLayout(("objects2"), numberOfColumns = 4, parent = "mainColumn")
    but_delOBJ = cmds.button(label = " remove selection",bgc = (.4,.4,.4))
    but_delOBJ_ALL = cmds.button(label = "remove selection -all layers",bgc = (.4,.4,.4))
    cmds.rowLayout(("objects4"), numberOfColumns = 6, parent = "mainColumn")
    but_showSelection = cmds.button(label = "show_selection",bgc = (.4,.4,.4))
    but_showSelection_ALL = cmds.button(label = "show_selection -all layers",bgc = (.4,.4,.4))
    but_showObjOnLayers = cmds.button(label = "showObjonLayers(OVL)",bgc = (.4,.4,.4))
    cmds.rowLayout(("objects5"), numberOfColumns = 6, parent = "mainColumn")
    but_hideSelection = cmds.button(label = "hide_selection",bgc = (.4,.4,.4))
    but_hideSelection_ALL = cmds.button(label = "hide_selection -all layers",bgc = (.4,.4,.4))
    cmds.rowLayout(("objects3"), numberOfColumns = 4, parent = "mainColumn")
    but_fixCams = cmds.button(label = "fixCamAssignments",bgc = (.4,.4,.4))
    but_ReNameLayers = cmds.button(label = "fixLayerNames",bgc = (.4,.4,.4))
    cmds.rowLayout(("objects6"), numberOfColumns = 4, parent = "mainColumn")
    but_lightRigOverides = cmds.button(label = "light rig rot layer overides",bgc = (.4,.4,.4), width = 150)
    but_lockUnlocks = cmds.button(label = "unlock cams",bgc = (.4,.4,.4), width = 150)
    ...
    but_copyALL_Layers = cmds.button(label = "copyALL_Layers",bgc = (.4,.4,.4), width = 150)
    ...
    buttonActiveAdObj = cmds.button(but_adOBJ, command = partial(addActObj,rl,check,buttSize_Add_Obj,butts,ButtSizeAdj,butts_addOBJ,buttSize_Add_Obj_adj,butts_delOBJ,buttSize_del_OBJ,buttSize_del_Obj_adj,but_showObjOnLayers,OILall),w = 150, edit = True)
    buttonActiveDelObj = cmds.button(but_delOBJ, command = partial(delActObj,rl,check,buttSize_Add_Obj,butts,ButtSizeAdj,butts_addOBJ,buttSize_Add_Obj_adj,butts_delOBJ,buttSize_del_OBJ,buttSize_del_Obj_adj,but_showObjOnLayers,OILall),w = 150, edit = True)
    buttonActiveAdObj_ALL = cmds.button(but_adOBJ_ALL, command = partial(addActObj_ALL,renderLayers,rl,check,buttSize_Add_Obj,butts,ButtSizeAdj,butts_addOBJ,buttSize_Add_Obj_adj,butts_delOBJ,buttSize_del_OBJ,buttSize_del_Obj_adj,but_showObjOnLayers,OILall),w = 150, edit = True)
    buttonActiveDelObj_ALL = cmds.button(but_delOBJ_ALL, command = partial(delActObj_ALL,renderLayers,rl,check,buttSize_Add_Obj,butts,ButtSizeAdj,butts_addOBJ,buttSize_Add_Obj_adj,butts_delOBJ,buttSize_del_OBJ,buttSize_del_Obj_adj,but_showObjOnLayers,OILall),w = 150, edit = True)
    buttonfixCams = cmds.button(but_fixCams, command = partial(fixCams,rl,renderLayers,camList,renCamMenu),w = 150, edit = True)
    buttonReNameLayers = cmds.button(but_ReNameLayers, command = partial(ReNameLayers,rl,renderLayers,camList,renCamMenu),w = 150, edit = True)
    buttonShowObj = cmds.button(but_showSelection, command = partial(showSel,butts,but_showObjOnLayers,SOLall),w = 150, edit = True)
    buttonShowObj_ALL = cmds.button(but_showSelection_ALL, command = partial(showSel_ALL,butts,but_showObjOnLayers,SOLall),w = 150, edit = True)
    buttonHideObj = cmds.button(but_hideSelection, command = partial(hideSel,butts,but_showObjOnLayers,SOLall),w = 150, edit = True)
    buttonHideObj_ALL = cmds.button(but_hideSelection_ALL, command = partial(hideSel_ALL,butts,but_showObjOnLayers,SOLall),w = 150, edit = True)
    ...
    cmds.button(but_copyALL_Layers, command = partial(copyAllLayers,renderLayers,vraySetBut,transformObut,materialsObut,cameraObut,lightObut,renderStatsObut,vrayObjectPropertiesObut,materials), edit = True)
