...
def objectChooseWin():
    ...
    def objects(object_Old,object_New):
        ...
        def object_New_translations(OBJ_1_TX,object_Old,object_New):
            ...
            if xforms_detected == 0:
                ...
                object_Old = object_Old_split[-1]
                object_Old = object_Old.replace(' ','')
                print 'object_Old = ',object_Old
                object_New_split = object_New.split('|')
                object_New = object_New_split[-1]
                object_New = object_New.replace(' ','')
                print 'object_New = ',object_New
                old_Xforms =  cmds.objectCenter('pSphere_old',gl = True)
        ...
        if checkTrans == 1:
            object_New_translations(OBJ_1_translations,object_Old,object_New)
        if checkMats == 1:
