...
#---------- UV set selection methods ----------
    ...
    def connected_materials(self,selected_texture):
        ...
        for connection_0 in connections_0:
            connection_type = cmds.nodeType(connection_0)
            if connection_type == 'shadingEngine':
                if connection not in connected_materials:
                    print '1 appending ' + connection_0
                    connected_materials.append(connection_0)
            else:
                print 'connection_0 = ',connection_0
                connections_1 = cmds.listConnections(connection_0,source = False) or []
                print 'connections_1 = ',connections_1
                for connection_1 in connections_1:
                    connection_type = cmds.nodeType(connection_1)
                    if connection_type == 'shadingEngine':
                        if connection_1 not in connected_materials:
                            print '2 appending ' + connection_0
                            connected_materials.append(connection_0)
                    else:
                        print 'connection_1 = ',connection_1
                        connections_2 = cmds.listConnections(connection_1,source = False) or []
                        print 'connections_2 = ',connections_2
                        for connection_2 in connections_2:
                            connection_type = cmds.nodeType(connection_2)
                            if connection_type == 'shadingEngine':
                                if connection_2 not in connected_materials:
                                    print '3 appending ' + connection_1
                                    connected_materials.append(connection_1)
                            else:
                                print 'connection_2 = ',connection_2
                                connections_3 = cmds.listConnections(connection_2,source = False) or []
                                print 'connections_2 = ',connections_3
                                for connection_3 in connections_3:
                                    connection_type = cmds.nodeType(connection_3)
                                    if connection_type == 'shadingEngine':
                                        if connection_3 not in connected_materials:
                                            print '4 appending ' + connection_2
                                            connected_materials.append(connection_2)
                                    else:
                                        print 'connection_3 = ',connection_3
                                        connections_4 = cmds.listConnections(connection_3,source = False) or []
                                        print 'connections_4 = ',connections_4
                                        for connection_4 in connections_4:
                                            connection_type = cmds.nodeType(connection_4)
                                            if connection_type == 'shadingEngine':
                                                if connection_4 not in connected_materials:
                                                    print '5 appending ' + connection_3
                                                    connected_materials.append(connection_3)
                                            else:
                                                print 'connection_4 = ',connection_4
                                                connections_5 = cmds.listConnections(connection_4,source = False) or []
                                                print 'connections_5 = ',connections_5
                                                for connection_5 in connections_5:
                                                    connection_type = cmds.nodeType(connection_5)
                                                    if connection_type == 'shadingEngine':
                                                        if connection_5 not in connected_materials:
                                                            print '6 appending ' + connection_4
                                                            connected_materials.append(connection_4)
