...
class RENAME(object):
    ...
    def shader_list(self):
        self.locked_shaders = ['lambert1']
        self.VRayMtl_list = cmds.ls(type = 'VRayMtl')
        self.phong_list = cmds.ls(type = 'phong')
        self.blinn_list = cmds.ls(type = 'blinn')
        self.lambert_blinn_list = cmds.ls(type = 'lambert')
        self.surface_shader_list = cmds.ls(type = 'surfaceShader')
        self.blend_material_list = cmds.ls(type = 'VRayBlendMtl')
